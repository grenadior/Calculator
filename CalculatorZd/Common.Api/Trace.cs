...
namespace Common.Api
{
    public class Trace
    {
        ...
        public static void WriteMessage(string p_sMessage, string p_sTitle, Category p_category,
            TraceEventType p_EventType, Priority p_priority)
        {
            Logger.Write(p_sMessage, GetCategoriesString(new Category[] { p_category }),
                         (int)p_priority, 1, p_EventType, p_sTitle,
                         new Dictionary<string, object>(0));
        }

        public static void WriteInformation(string p_sMessage, string p_sTitle, Category p_category)
        {
            WriteMessage(p_sMessage, p_sTitle, p_category, TraceEventType.Information, Priority.Low);
        }
        ...
        public static void WriteError(string p_sMessage, string p_sTitle, Category p_category)
        {
            WriteMessage(p_sMessage, p_sTitle, p_category, TraceEventType.Error, Priority.High);
        }

        public static void WriteError(string p_sMessage, Category p_category)
        {
            WriteError(p_sMessage, string.Empty, p_category);
        }
